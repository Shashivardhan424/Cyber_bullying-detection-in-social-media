...
urlpatterns = [
    ...
    re_path(r'^Predict_Tweet_Meesage_Type/$', remoteuser.Predict_Tweet_Meesage_Type, name="Predict_Tweet_Meesage_Type"),
    ...
    re_path(r'^Find_Predicted_Cyberbullying_Detection_Ratio/$', serviceprovider.Find_Predicted_Cyberbullying_Detection_Ratio, name="Find_Predicted_Cyberbullying_Detection_Ratio"),
    re_path(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    re_path(r'^View_Predicted_Cyberbullying_Detection_Type/$', serviceprovider.View_Predicted_Cyberbullying_Detection_Type, name="View_Predicted_Cyberbullying_Detection_Type"),
